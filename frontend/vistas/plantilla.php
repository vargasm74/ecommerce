...
if(isset($_GET["ruta"])){
	...
	if($ruta != null || $rutas[0] == "articulos-gratis" || $rutas[0] == "lo-mas-vendido" || $rutas[0] == "lo-mas-visto" || $rutas[0] == "ofertas"){
...
<script src="<?php echo $url; ?>vistas/js/carrito-de-compras.js?v=20260922-2"></script>
